...
function App() {
  ...
  return (
    <ThemeProvider>
      <div className={`min-h-screen flex flex-col ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'} transition-colors duration-300`}>
        ...
        <main className="flex-1 container mx-auto p-4">
          <div className="bg-white p-2 md:p-4 rounded shadow-md mb-4 flex justify-start gap-4">
            ...
            <div className='w-[25%] md:w-[27.5%] md:max-w-[20%]'><CategoryFilter categories={['work', 'personal', 'shopping']} onFilter={setFilter} /></div>
